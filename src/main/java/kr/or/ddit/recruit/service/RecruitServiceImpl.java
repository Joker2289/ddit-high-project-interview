...
public class RecruitServiceImpl implements IRecruitService{
	...
	public List<RecruitVo> searchRecrListByJob_local(String search_local) {
		List<RecruitVo> recrList = recrDao.searchRecrListByJob_local(search_local);
	...
	public List<String> getPersonalCorpId(String mem_id) {
		List<String> personalCorpIdList = recrDao.getPersonalCorpId(mem_id);
	...
	public List<String> getPersonalUserId(String param) {
		List<String> personalUserIdList = recrDao.getPersonalUserId(param);
