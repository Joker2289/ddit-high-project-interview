...
<form action="/educationInsert" method="post" id="educationInsertFrm" enctype="multipart/form-data">
	<div>
		<div class="modalRow">
			<div class="modalHalfLeft">
				<label class="essential">대학교 </label>
				<input class="form-control" type="text" name="school_name" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">
			</div>
		...
		<div class="modalRow">
			<div class="modalHalfLeft">
				...
				<input class="form-control select_date"  name="admission" type="text" >
			</div>
			<div class="modalHalfRight">
				<label class="essential">졸업년도 </label>
				<input class="form-control select_date" name="graduation" type="text" >
			</div>
		</div>
