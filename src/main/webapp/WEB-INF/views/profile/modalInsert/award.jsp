...
<form action="/award_historyInsert" method="post" id="award_historyInsertFrm" enctype="multipart/form-data">
	<div>
		<div class="modalRow">
			<div class="modalHalfLeft">
				<label class="essential">상 이름</label>
				<input class="form-control" type="text" name="award_name">
			</div>
			<div class="modalHalfRight">
				<label class="essential">발급 기관</label>
				<input class="form-control" type="text" name="award_org">
			</div>
		</div>
		<div class="modalRow">
			<div class="modalHalfLeft">
				<label class="essential">수상 일자</label>
				<input class="form-control select_date" type="text" name="award_date">
			</div>
		</div>
