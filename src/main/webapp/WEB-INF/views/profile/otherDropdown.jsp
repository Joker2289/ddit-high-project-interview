...
<ul class="dropdown-menu" style="display: block; top: 425px;width: 155px; min-height: 40px; ">
	<li class="dropdownAccordion otherDropdown" style="width: 155px;">
		<a href="/profilePDF?user_id=${SESSION_MEMBERVO.mem_id }" style="padding: 0 15px 0 0; width: 140px;"><span style="font-size: 24px;"><i class="fas fa-cloud-download-alt"></i></span>PDF로 저장</a>
	</li>
