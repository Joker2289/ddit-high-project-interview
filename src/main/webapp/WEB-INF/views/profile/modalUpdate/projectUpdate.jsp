...
<fmt:formatDate value="${project_careerVo.start_date}" pattern="yy/MM/dd" var="fmtStart_date"/>
<fmt:formatDate value="${project_careerVo.end_date}" pattern="yy/MM/dd" var="fmtEnd_date"/>
...
<div class="modal-header">
	...
	<h4 class="modal-title">프로젝트</h4>
</div>
<div class="modal-body">
<form action="/project_careerUpdate" method="post" id="project_careerUpdateFrm" enctype="multipart/form-data">
	<div>
		<div class="modalRow">
			<div class="modalHalfLeft">
				<label class="essential">프로젝트명 </label>
				<input class="form-control" type="text" name="project_name" value="${project_careerVo.project_name }">
			</div>
		...
		<div class="modalRow">
			<div class="modalHalfLeft">
				...
				<input class="form-control select_date" type="text" name="start_date" value="${project_careerVo.start_date }">
			</div>
			<div class="modalHalfRight end_date">
				<label class="essential">종료일</label>
				<input class="form-control select_date" type="text" name="end_date" value="${project_careerVo.end_date }">
			</div>
		</div>
		<div class="modalRow">
			<div class="modalHalfLeft">
	...
	<input type="hidden" value="${project_careerVo.project_code }" name="project_code">
</form>
</div>
...
<script>
	...
	$("#project_careerSave").on("click",function(){
		...
		if($(".end_dateIng").is(":checked")){
 		...
 		$("#project_careerUpdateFrm").submit();
	});
	...
	$("input[name=start_date]").datepicker('setDate', '${fmtStart_date}');
	
	if ($("input[name=end_date]").val().trim()==""){
		$(".end_dateIng").prop('checked', true);
		$(".end_date").hide();
	}else{
		$(".end_dateIng").prop('checked', false);
		$("input[name=end_date]").datepicker('setDate', '${fmtEnd_date}');
	}
</script>