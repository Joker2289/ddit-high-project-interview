...
<form action="/abilityUpdate" method="post" id="abilityUpdateFrm">
	<div>
		<div class="modalRow">
			<div class="modalHalfLeft">
				<label class="essential">보유기술 </label>
				<input class="form-control" type="text" name="ability_item" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false" value="${abilityVo.ability_item}">
			</div>
	...
	<input type="hidden" value="${abilityVo.ability_code }" name="ability_code">
</form>
</div>
<div class="modal-footer">
	<a class="btn btn-default" style="margin-right: 599px;" href="/abilityDelete?ability_code=${abilityVo.ability_code }">삭제</a>
