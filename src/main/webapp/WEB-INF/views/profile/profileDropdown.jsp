...
<ul class="dropdown-menu" style="display: block; top: 410px;left: 40px; width: 310px; min-height: 240px;">
   ...
   <div class="collapse" id="introduction">
      <div class="well">
         ...
         <button class="btn btn-default"><span style="color: #777a7d;"><i class="fas fa-plus"></i></span></button>
      </div>
   </div>
   <li class="divider"></li>
