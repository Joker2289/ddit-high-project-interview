...
<c:if test="${recrList2.size() >= 1 }">
	...
	<c:forEach items="${recrList2 }" varStatus="i" var="rRVo">
		<li style="float: left; text-align: left;"><div class="recrBox" style="width: 280px; box-shadow: 0 3px 3px rgba(0, 0, 0, .175);
				margin-right: 10px; padding: 13px; font-size: 16px; height: 270px; border-radius: 4px;
				border: 1px solid; border-color: #d9d9d9;" data-recruit_code="${rRVo.recruit_code }"
				data-idx="${i.index }">
