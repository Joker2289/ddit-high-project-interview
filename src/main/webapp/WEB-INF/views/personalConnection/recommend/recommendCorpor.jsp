...
<c:choose>
	...
	<li>
		<div class="whiteBox">
			<div
				style="width: 120px;height:78px;background-image:url(${not empty logo_path ? logo_path : profile_addrpath});background-repeat: no-repeat;background-size: 120px;background-position: center;margin: 15px 0 12px 22px;"></div>
