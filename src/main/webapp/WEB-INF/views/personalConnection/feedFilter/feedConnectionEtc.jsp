...
<c:forEach items="${connectionsEtcList}" var="etc">
	<div style="width: 225px;">
		<div class="corporation" style="padding-left : 15px;">
			<div
				style="width: 59px;height: 59px;background-image:url(/profile?mem_id=${etc.user_id});background-repeat: no-repeat;background-size: cover;background-position: center;margin-left: 5px;margin-top: 15px; margin-bottom: 12px;">
			</div>
			<div>
