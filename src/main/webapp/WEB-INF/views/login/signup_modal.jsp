  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title fs-37" id="myModalLabel">Sign up - User</h4>
      ...
      <div class="modal-body">
	        ...
	        <div class="wrap-input-custom validate-input m-b-23" data-validate = "Username is reauired">
				<span class="label-input100">ID</span>
				<input class="input100" type="text" id="userId" name="userId" placeholder=" Your ID">
				<span class="focus-input100" data-symbol="&#xf206;"></span>
			</div>
			
			<div class="wrap-input-custom validate-input m-b-23" data-validate="Password is required">
