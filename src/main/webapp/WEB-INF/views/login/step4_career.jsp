...
<!DOCTYPE html>
		...
		<div class="jk-row">
	  	 	<div id="modal-head" class="jk-modal-head">
	  	 		...
	  	 		<img src="${ cp }/images/step4_career.png"  width="500" height="80">
		...
		<div class="jk-row">
		     <div id="modal-body" class="jk-modal-body">
					...
					<div class="wrap-input-custom2">
						<button id="step_education" class="jk-btn-long2" type="button">아직 학생 이세요??</button>
					</div>			 
  		...
  		$("#nextStep").on('click', function(){
			...
			console.log("step3 : " + JSON.stringify(step3));
	  		$.ajax({
	  			...
	  			url : "${cp}/signUp/goStep5FromCareer",
	  			method : "post",
		...
		//학력정보 입력 단계로 이동
		$("#step_education").on('click', function(){
			
	  		$.ajax({
	  			
	  			url : "${cp}/signUp/returnStepEducation",
	  			method : "post",
	  			success : function(data){
	  				$(".jk-modal").html(data);
	  			}
