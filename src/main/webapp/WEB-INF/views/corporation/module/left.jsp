...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div style="width: 219px;border-radius:5px; box-shadow: 0px 2px 4px #aaa; font-size: large;font-weight:400;padding: :3px 2px 0 30px"> 
    	<div style="background-color: #FFFFFFFF; height: 35px; border-top-left-radius: 5px;border-top-right-radius: 5px;  border: 1px solid #AAAAAA; padding: 10">
			<a href="<%=request.getContextPath()%>/corporation?corp_id=${corporationInfo.corp_id }"> <label style="margin-top: 5px">&emsp;홈</label></a><br> 
		</div>
		<div style="background-color: #FFFFFFFF; margin-top: -1px; height: 35px; border: 1px solid #AAAAAA;">
			<a href="<%=request.getContextPath()%>/corporationIntroduction?corp_id=${corporationInfo.corp_id }" style="vertical-align:baseline;ma"> <label style="margin-top: 5px">&emsp;소개</label></a><br>
		</div>
		<div style="background-color: #FFFFFFFF; margin-top: -1px ; height: 35px;   border: 1px solid #AAAAAA;">
			<a href="<%=request.getContextPath()%>/corporationRecruitment?corp_id=${corporationInfo.corp_id }"><label style="margin-top: 5px"> &emsp;채용</label></a><br>
		</div>
