...
<div style="border: 1px solid;margin-top:-1px; height: 150px">
	<div style="margin-left: 155px; margin-top: 10px" > 
		<label for="corporationNm"> 500 error </label> <label>${corporationVo.corp_name }</label>
			<div style="float: right; margin-right: 10px; ">
				<input type="button" value="+팔로우" name="follow" onclick="follow">
				<input type="button" value="..." name="report&follw" /> <br> 
			</div>
			<br>
		<label for="addr1">대전광역시 중구 중앙로 76 영민빌딩 2층</label> <label>${corporationVo.addr1 }</label> <br>
	</div>
	<div style="margin-top: 20px; margin-left: 30px;">
		<label> 안녕하세요 500error 입니다. 저희 회사는 error를 자주 냅니다.${corporationVo.corp_profile } </label>
		<br>  
		<br>  
