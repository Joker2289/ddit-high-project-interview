...
<h2 class="setting_title"> <i class="fas fa-cog"></i> 블로그 설정 </h2>
...
<div class="setting_menu">
	...
	<div class="setting_content">
		...
		<button class="btn btn-primary setting_Btn" onclick="updateBlog('blog_name');">OK</button>
	</div>
</div>
...
<div class="setting_menu">
	...
	<div class="setting_content">
		<form id="name_act_form">
			 <input id="name_y" type="radio" name="name_act" value="y" onclick="updateBlog('name_act');" /> 사용
			 <input id="name_n" type="radio" name="name_act" value="n" onclick="updateBlog('name_act');" /> 미사용
		</form>
	</div>
</div>
...
<div class="setting_menu">
	...
	<div class="setting_content">
		<button class="btn btn-primary setting_Btn" onclick="findImage();"><i class="fas fa-search"></i> 사진 찾기</button>
		<form id="imageForm">
...
function updateBlog(update_param){
	...
	$.ajax({
		...
		data : {"user_id" : user_id, "update_param" : update_param, "update_content" : update_content},
